  ...
  return (
    <ScrollView contentContainerStyle={styles.scrollViewContainer}>
      ...
      <View style={styles.Bike_Package_Parent}>
        <TouchableOpacity style={styles.Bike_Package_Btn} onPress={handleBikeDealer}>
          <Text style={styles.Bike_Package_Btn_Txt}>Bike Packeges</Text>
          <Text style={styles.Bike_Package_Btn_Txt_1}><MaterialCommunityIcons name="motorbike" size={24} color="black" /></Text>
        </TouchableOpacity>
      </View>
      {/* --- Bike Package --- */}
